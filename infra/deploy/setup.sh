...
echo ""
echo "   echo '<your-public-key>' | sudo tee -a /home/deploy/.ssh/authorized_keys"
echo ""
...
echo ""
echo "   # Download Great Britain OSM extract (~1.5 GB) — saved as map.osm.pbf (the name GraphHopper expects):"
echo "   wget -O $DEPLOY_DIR/graphhopper/data/map.osm.pbf https://download.geofabrik.de/europe/great-britain-latest.osm.pbf"
echo ""
